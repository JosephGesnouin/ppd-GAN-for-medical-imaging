...
# os.system("wget https://s3-eu-west-1.amazonaws.com/ppd-gan-medical-imaging/breast-cancer.zip -P "+d1)
# print("Unzip ...")
# zip_ref = zipfile.ZipFile(d1+"/breast-cancer.zip", 'r')
# zip_ref.extractall(d1)
# zip_ref.close()
# os.remove(d1+"/breast-cancer.zip")
